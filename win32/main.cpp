...
EventKey Wm_Win32::translateKey(int key)
{
	switch(key)
	{
	case 0x41:
...
bool Wm_Win32::query_update(FILE *f)
{
	...
	{
		if(low_date_time != attrib.st_mtime && attrib.st_size > 0) // Is the file updated?
		{
...
int WINAPI Wm_Win32::main(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
