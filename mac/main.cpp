...
void Wm_X11::hide_mouse( void )
{
	//v_printf(1, "hide_mouse\n");
	XDefineCursor( dpy, win, null_cursor );
}

void Wm_X11::show_mouse( void )
{
	//v_printf(1, "show_mouse\n");
...
void Wm_X11::render_text(int x, int y, float red, float green, float blue, float alpha, const char * text)
{
				...
				case ButtonRelease:
					{
						...
						switch( event2.xbutton.button )
						{
						case Button1: event( 1, 0, x, y ); break;
						case Button3: event( 1, 1, x, y ); break;
						}
				...
				case MotionNotify:
					{
						...
						switch( event2.xbutton.button )
						{
							case Button1: event( 2, 0, x, y ); break;
							case Button3: event( 2, 1, x, y ); break;
							default: event( 2, -1, x, y ); break;
						}
						break;
					}
